    ...
    <>
      <main className={style.container}>
        ...
        <div className={style.contactForm}>
          ...
          <p className="max-w-lg py-6 font-sans">
      ...
      <aside className={style.aside}>
        <div className={style.asideLinks}>
          <p className="font-mono uppercase">Until we&apos;re in touch:</p>
          <ul>
...
const style = {
  ...
  image: [
    "will-stick w-full aspect-[320/224] bg-salley-dark bg-[url(../assets/images/malte-michels-s4wGZw3UuLk-unsplash.jpg)] bg-cover",
    "md:flex-1",
  ].join(" "),
  ...
  aside: [
    "flex w-full px-8 py-20 bg-green-950 text-salley-light",
    "md:gap-20 md:p-20",
  ].join(" "),
  asideLinks: ["max-w-lg ml-auto", "md:w-1/2"].join(" "),
  listItem: ["border-salley-light py-8 not-last:border-b-1 last:pb-0"].join(
    " ",
  ),
