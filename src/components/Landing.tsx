...
export const Hero = () => {
  const classNames = {
    title: [
      `mx-4 mt-20 mb-8 font-serif font-semibold text-moss text-5xl 
      md:absolute md:w-md
      md:text-[5rem]/[.9] md:-translate-y-7/12 md:-translate-x-12/48
      lg:text-[7.3rem]/[.9] lg:-translate-y-9/12 lg:-translate-x-27/48
      xl:w-xl xl:top-20 xl:text-8xl xl:-translate-x-1/3`,
      "md:absolute md:bottom-0 md:translate-x-1/16 xl:translate-x-2/3",
    ],
    paragraph: `mt-4 text-sm font-sans 
    md:absolute md:translate-y-full md:w-[250px] md:-bottom-4 lg:-bottom-20
    xl:bottom-0 xl:translate-y-0`,
  ...
  return (
    <section className="will-stick flex items-center h-screen">
      <div className={`${classNames.container} w-full`}>
        ...
        <div className={`${classNames.paragraph} md:left-14`}>
          <p>Aaron Salley</p>
        ...
        <div className={`${classNames.paragraph} hidden md:block md:right-14`}>
          <p className="mb-4">
            Based in NYC
            <br />
            Working Worldwide
...
export const Intro = () => (
  <main className="mx-4 md:mx-14 md:flex md:justify-between">
    ...
    <div className="max-w-[780px] xl:w-8/12">
      ...
      <p className="font-sans text-lg text-warm-gray mb-8 md:w-1/2">
      ...
      <Button href="/about" variant="hollow">
        Learn More
      </Button>
    </div>
  </main>
...
export const CaseStudies = () => {
  const renderCases = () => {
    return caseStudies.slice(0, 4).map((caseStudy, i) => (
      <article
        key={caseStudy.id}
      ...
      >
        ...
        <div>
          ...
          <p className="text-warm-gray">{caseStudy.excerpt}</p>
        </div>
...
export const Workflow = () => {
  ...
  return (
    <section className="mx-4 md:mx-14">
      <div className="relative lg:flex md:justify-between md:items-end">
        <h2 className="text-moss font-bold font-sans mb-4 md:absolute md:right-0 md:-top-4 lg:top-0">
          My Workflow
        </h2>
        ...
        <p className="text-sm text-warm-gray max-w-[366px] lg:w-1/3 lg:absolute lg:right-0 lg:max-xl:-bottom-1/12">
      ...
      <ul className="w-full mt-12 flex flex-col gap-4 max-md:px-15 md:grid lg:gap-8 md:grid-cols-2 lg:grid-cols-3">
        {renderSteps()}
      </ul>
    </section>
  );
