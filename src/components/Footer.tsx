...
export default function Footer() {
  return (
    <footer className="relative flex flex-wrap bg-soft-charcol text-warm-ivory gap-y-12 md:gap-y-16">
...
const style = {
  ...
  divider:
    "hidden absolute top-[80px] w-full border-t border-warm-ivotext-warm-ivory opacity-30 md:block md:order-3",
  name: [
