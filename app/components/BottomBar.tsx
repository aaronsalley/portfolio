...
export default function BottomBar({ pages, socials }: BottomBar) {
  return (
      ...
      <div className='order-2 sm:order-3 grid sm:grid-cols-2 sm:mb-9 mx-10 sm:gap-10 lg:mx-20 lg:gap-20 xl:gap-66 xl:mx-60'>
        ...
        <div>
          <p className='mb-12 hidden sm:block font-sans font-light text-sm lg:text-base'>
            Get in touch with us to discuss your next project. We&apos;re eager
            to learn about your business and explore how our tailored digital
