...
export default async function RootLayout({
  ...
  const data: LayoutProps = {
    pages: [
      ...
      { name: 'Insights', href: 'https://aaronsalley.medium.com/' },
      { name: 'Contact', href: 'mailto:hello@aaronsalley.com' },
    ],
    links: [],
    socials: {
      instagram: {
  ...
  return (
    ...
    >
      ...
      <body>
        <GTM_no_script gtmId={process.env.NEXT_PUBLIC_GTM_ID} />
        <TopBar {...data} />
        {children}
        <BottomBar {...data} />
      </body>
